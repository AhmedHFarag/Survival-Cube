...
public class Weapon1 : DefaultWeapon
{
    ...
    public override void Fire()
    {
        ...
        currentbulletObj1.GetComponent<Rigidbody>().AddForce(transform.forward * 5000);
        ...
        //currentbulletObj2.GetComponent<Rigidbody>().AddForce(transform.forward * 5000);
        ...
        //currentbulletObj3.GetComponent<Rigidbody>().AddForce(transform.forward * 5000);
